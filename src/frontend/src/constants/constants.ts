...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit the Python code for your custom component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "Unnest: Create, Chain, Communicate.",
...
export const API_PAGE_PARAGRAPH =
  "Your secret Unnest API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const LANGFLOW_CHAT_TITLE = "Unnest Chat";
...
export const INSERT_API_KEY = "Insert your Unnest API key.";
