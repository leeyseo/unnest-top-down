    ...
    return (
      <div className="align-center flex h-full w-full flex-col items-center justify-center gap-5">
        ...
        <div className="align-center flex w-full justify-center">
          <div className="unnest-chat-desc align-center flex justify-center px-6 py-8">
            <div className="unnest-chat-desc-span">{t("output.csvError")}</div>
          </div>
        </div>
      </div>
    );
    ...
    <div className="h-full rounded-md border bg-muted">
      {status === "nodata" && (
        <div className="align-center flex h-full w-full flex-col items-center justify-center gap-5">
          ...
          <div className="align-center flex w-full justify-center">
            <div className="unnest-chat-desc align-center flex justify-center px-6 py-8">
              <div className="unnest-chat-desc-span">
                {t("output.csvNoData")}
              </div>
            </div>
          </div>
